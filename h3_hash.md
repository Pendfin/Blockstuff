...
- passwords are stored in multiple ways
  - in text files
  - database like sql-database in case of web applications or proprietary database in case of active directory
- in password attacks example - Petay attack was able to dump passwords out of system and use normally looking traffic to attack other systems with these stole credentials 
- two ways of defending - protection in rest(limit access, intrusion detection, endpoint protection ) and in traffic(encryption)
- end-user standpoint you should aply longer passwords and multifactor authentication
#### 6.2
...
- hashcat is another program to use for cracking passwords
  ...
  - you can choose dictionary or brute word
  - multiple hashtypes or algorithms supported
  - you can export results in the file - it takes only minutes to brute force
  - you can e.g. use english dictionary
- you can do it onsite or on designated workstation were you can optimaze your performance
#### 6.7
- Organisations should focus on password protection
  - hashing is not enough
  - demand strong passwords (longer than eight characters)
  - store them secure
- User
